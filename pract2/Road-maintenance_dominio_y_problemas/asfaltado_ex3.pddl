...
(:durative-action probar_carga
 :parameters (?t - tramo)
 :duration (= ?duration (duracion-probar_carga))
 :condition (and (at start (aplastado ?t))
                 (at start (not (probado_carga ?t))))
 :effect (at end (probado_carga ?t)))
